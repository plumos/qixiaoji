    ...
    <div id="gods">
        ...
        <div class="sselect" style="display: inline">
          <el-dropdown trigger="click">
            <span class="el-dropdown-link">
              全部仓库<i class="el-icon-arrow-down el-icon--right"></i>
            </span>
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item>全部仓库</el-dropdown-item>
              <el-dropdown-item>禁用</el-dropdown-item>
              <el-dropdown-item>1号仓</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </div>
      ...
      <div class="dvtable">
        <el-table class="ttable"
          ...
          <el-table-column  prop="spec"   label="入库日期"  ></el-table-column>
          <el-table-column  prop="unit"   label="所属仓库"  ></el-table-column>
          <el-table-column  prop="store"   label="调整金额"  ></el-table-column>
