<template>
  <div>
    <div id="gods">
      <div class="tops">
        <div class="sselect" style="display: inline">
      ...
      <div class="dvtable">
        <el-table class="ttable"
          ...
          <el-table-column  prop="name"  label="采购单号"  ></el-table-column>
          <el-table-column  prop="spec"   label="供应商"  ></el-table-column>
          <el-table-column  prop="unit"   label="采购金额"  ></el-table-column>
          <el-table-column  prop="store"   label="制单人"  ></el-table-column>
          <el-table-column  prop="store"   label="采购员"  ></el-table-column>
          <el-table-column  prop="store"   label="时间"  ></el-table-column>
          <el-table-column  prop="store"   label="状态"  ></el-table-column>
          <el-table-column  prop="store"   label="备注"  ></el-table-column>
          <el-table-column
            fixed="right"
            width="150">
