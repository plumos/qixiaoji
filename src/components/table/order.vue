<template>
  <div id="order">
    ...
    <el-table class="ttable"
      ...
      <el-table-column  prop="ordno"   label="订单号"  ></el-table-column>
      ...
      <el-table-column  prop="store"   label="出库/发货" ></el-table-column>
      <el-table-column  prop="state" sortable  label="状态"  ></el-table-column>
      <el-table-column  prop="moneystate"   label="收款状态" ></el-table-column>
      <el-table-column
        fixed="right"
        label="操作"
        width="150">
